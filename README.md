...
- `index.html` — landing page and short overview
- `presentation.html` — reveal.js slide presentation
- `assets/site.css` — shared styling

## Public-facing boundary

Only curated public-facing material should be published here. The private PhD research workspace remains the place for proposal records, literature notes, ethics planning, supervision records, reflective logs, and analysis development.
